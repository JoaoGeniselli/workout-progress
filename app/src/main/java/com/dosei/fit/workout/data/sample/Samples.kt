package com.dosei.fit.workout.data.sample

import com.dosei.fit.workout.data.model.Equipment
...
fun sampleExercises(): List<Exercise> {
...
fun sampleTraining(id: Long = 1L, name: String = "Treino A") = Training(
    id = id,
    name = name,
    notes = "Segunda e Quinta",
